...
* [Soothsayer](https://github.com/georgeguimaraes/soothsayer) ⭐ 140 | 🐛 1 | 🌐 Elixir | 📅 2026-09-19 - Time series forecasting library inspired by Facebook's Prophet and NeuralProphet.
* [Mockinjay](https://github.com/acalejos/mockingjay) ⭐ 75 | 🐛 1 | 🌐 Elixir | 📅 2023-09-02 - Implementation of Microsoft's [Hummingbird](https://github.com/microsoft/hummingbird) ⭐ 3,546 | 🐛 76 | 🌐 Python | 📅 2026-09-14 library for converting trained Decision Tree models into Nx tensor computations.
...
* [Bumblebee](https://github.com/elixir-nx/bumblebee) ⭐ 1,670 | 🐛 33 | 🌐 Elixir | 📅 2026-09-22 - Pre-trained neural network models on top of Axon. Provides integration with [Hugging Face](https://huggingface.co/).
...
* [xberg](https://github.com/xberg-io/xberg) ⭐ 9,333 | 🐛 15 | 🌐 Rust | 📅 2026-09-23 - Document intelligence for RAG ingestion (parsing, OCR, tables, chunking across 100+ formats) with a Rust core and first-party Elixir bindings.
...
* [ReqLLM](https://github.com/agentjido/req_llm) ⭐ 581 | 🐛 7 | 🌐 Elixir | 📅 2026-09-22 - A Req-based package to call LLM APIs that standardizes the API calls and responses for LLM providers.
* [Arcana](https://github.com/georgeguimaraes/arcana) ⭐ 338 | 🐛 1 | 🌐 Elixir | 📅 2026-09-22 - Embeddable RAG library for Elixir/Phoenix with agentic pipelines and dashboard.
...
* [AshAi](https://github.com/ash-project/ash_ai) ⭐ 189 | 🐛 13 | 🌐 Elixir | 📅 2026-09-23 - Structured outputs, vectorization and tool calling for your Ash application with LangChain integration and MCP server capabilities.
...
* [LLM Composer](https://github.com/doofinder/llm_composer) ⭐ 40 | 🐛 0 | 🌐 Elixir | 📅 2026-09-23 - Multi-provider LLM library with routing, fallback, streaming, and cost tracking for OpenAI, Anthropic, Gemini, and more.
...
* [Jido](https://github.com/agentjido/jido) ⭐ 1,864 | 🐛 1 | 🌐 Elixir | 📅 2026-09-21 - Framework for building autonomous, distributed agent systems with modular actions, stateful agents, and sensors. AI-framework agnostic.
...
* [Legion](https://github.com/software-mansion-labs/legion) ⭐ 217 | 🐛 6 | 🌐 Elixir | 📅 2026-09-19 - Runtime for AI agents that live inside your Elixir app and act by writing code, run in monitored sandboxes, with tools defined as Elixir modules. By Software Mansion.
...
* [Alloy](https://github.com/alloy-ex/alloy) ⭐ 88 | 🐛 4 | 🌐 Elixir | 📅 2026-07-03 - Minimal, OTP-native completion and tool-call loop. Provider-agnostic, with cost guards, and deliberately not a framework.
* [BeamWeaver](https://github.com/caudena/beam_weaver) ⭐ 57 | 🐛 0 | 🌐 Elixir | 📅 2026-09-21 - LangChain, LangGraph and Deep Agents patterns as native OTP workflows, with tools, memory, human-in-the-loop and tracing.
...
* [A2A](https://github.com/actioncard/a2a-elixir) ⭐ 21 | 🐛 10 | 🌐 Elixir | 📅 2026-09-23 - Elixir implementation of the Agent-to-Agent (A2A) protocol with GenServer-based agents, JSON-RPC 2.0 dispatch, SSE streaming, skill-based discovery, and fleet supervision.
* [A2UI](https://github.com/actioncard/a2ui-elixir) ⭐ 8 | 🐛 0 | 🌐 Elixir | 📅 2026-09-23 - Phoenix LiveView renderer for the Agent-to-UI (A2UI) protocol, converting declarative JSONL agent messages into native LiveView components with two-way data binding.
...
* [Symphony](https://github.com/openai/symphony) ⭐ 27,377 | 🐛 8 | 🌐 Elixir | 📅 2026-09-15 - OpenAI's reference implementation, written in Elixir, of an orchestrator that runs Codex coding agents against an issue tracker in isolated per-issue workspaces.
...
* [claude-code-elixir](https://github.com/georgeguimaraes/claude-code-elixir) ⭐ 180 | 🐛 0 | 🌐 Elixir | 📅 2026-09-20 - Collection of Claude Code plugins for Elixir development. Includes LSP integration, formatting and compilation hooks, and thinking skills for Elixir, Phoenix, Ecto, and OTP patterns.
* [Elixir Agent Tools](https://github.com/georgeguimaraes/elixir-agent-tools) ⭐ 180 | 🐛 0 | 🌐 Elixir | 📅 2026-09-20 - Elixir development skills for coding agents (language idioms, Phoenix, Ecto, OTP, Oban), with optional Mix checks and Expert language server integration. Works with Claude Code, Codex and OpenCode.
* [Anubis MCP](https://github.com/zoedsoupe/anubis-mcp) ⭐ 172 | 🐛 26 | 🌐 Elixir | 📅 2026-09-07 - SDK for the Model Context Protocol (MCP) with support for multiple transport options (STDIO, HTTP/SSE, WebSocket).
...
* [llm\_db](https://github.com/agentjido/llm_db) ⭐ 62 | 🐛 1 | 🌐 Elixir | 📅 2026-09-23 - LLM model metadata database with O(1) lookups for provider capabilities, pricing, and context limits. Packaged as a dependency snapshot with no runtime network calls needed.
