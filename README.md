...
* [Nx](https://github.com/elixir-nx/nx) ⭐ 2,906 | 🐛 2 | 🌐 Elixir | 📅 2026-09-10 - Tensors for Elixir with compilation to CPU/GPU. It is the base for a lot of other libraries.
...
* [Soothsayer](https://github.com/georgeguimaraes/soothsayer) ⭐ 139 | 🐛 1 | 🌐 Elixir | 📅 2026-09-17 - Time series forecasting library inspired by Facebook's Prophet and NeuralProphet.
...
* [xberg](https://github.com/xberg-io/xberg) ⭐ 9,319 | 🐛 6 | 🌐 Rust | 📅 2026-09-17 - Document intelligence for RAG ingestion (parsing, OCR, tables, chunking across 100+ formats) with a Rust core and first-party Elixir bindings.
...
* [ReqLLM](https://github.com/agentjido/req_llm) ⭐ 576 | 🐛 8 | 🌐 Elixir | 📅 2026-09-17 - A Req-based package to call LLM APIs that standardizes the API calls and responses for LLM providers.
...
* [AshAi](https://github.com/ash-project/ash_ai) ⭐ 189 | 🐛 14 | 🌐 Elixir | 📅 2026-09-17 - Structured outputs, vectorization and tool calling for your Ash application with LangChain integration and MCP server capabilities.
...
* [Jido](https://github.com/agentjido/jido) ⭐ 1,860 | 🐛 1 | 🌐 Elixir | 📅 2026-09-17 - Framework for building autonomous, distributed agent systems with modular actions, stateful agents, and sensors. AI-framework agnostic.
...
* [Sagents](https://github.com/sagents-ai/sagents) ⭐ 273 | 🐛 3 | 🌐 Elixir | 📅 2026-09-17 - Framework for interactive AI agents with OTP supervision, middleware composition, human-in-the-loop approvals, sub-agent delegation, and a Phoenix LiveView debugger.
* [Legion](https://github.com/software-mansion-labs/legion) ⭐ 209 | 🐛 4 | 🌐 Elixir | 📅 2026-09-16 - Runtime for AI agents that live inside your Elixir app and act by writing code, run in monitored sandboxes, with tools defined as Elixir modules. By Software Mansion.
...
* [Alloy](https://github.com/alloy-ex/alloy) ⭐ 85 | 🐛 4 | 🌐 Elixir | 📅 2026-07-03 - Minimal, OTP-native completion and tool-call loop. Provider-agnostic, with cost guards, and deliberately not a framework.
...
* [Bazaar](https://github.com/georgeguimaraes/bazaar) ⭐ 8 | 🐛 1 | 🌐 Elixir | 📅 2026-09-17 - Elixir SDK for serving AI agent commerce protocols (UCP and ACP) from a single Phoenix handler. Supports Google Shopping agents (UCP) and OpenAI/Stripe agents (ACP) with automatic request/response translation between protocols.
...
* [Symphony](https://github.com/openai/symphony) ⭐ 27,271 | 🐛 8 | 🌐 Elixir | 📅 2026-09-15 - OpenAI's reference implementation, written in Elixir, of an orchestrator that runs Codex coding agents against an issue tracker in isolated per-issue workspaces.
...
* [llm\_db](https://github.com/agentjido/llm_db) ⭐ 60 | 🐛 1 | 🌐 Elixir | 📅 2026-09-17 - LLM model metadata database with O(1) lookups for provider capabilities, pricing, and context limits. Packaged as a dependency snapshot with no runtime network calls needed.
...
* [ex\_mcp](https://github.com/azmaveth/ex_mcp) ⭐ 29 | 🐛 2 | 🌐 Elixir | 📅 2026-09-16 - Complete Elixir implementation of the Model Context Protocol (v2025-11-25) with client and server support, multiple transports including native BEAM, and 2600+ tests.
