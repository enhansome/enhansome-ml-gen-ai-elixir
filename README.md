...
* [Nx](https://github.com/elixir-nx/nx) ⭐ 2,899 | 🐛 2 | 🌐 Elixir | 📅 2026-08-18 - Tensors for Elixir with compilation to CPU/GPU. It is the base for a lot of other libraries.
...
* [Scholar](https://github.com/elixir-nx/scholar) ⭐ 495 | 🐛 11 | 🌐 Elixir | 📅 2026-08-17 - Traditional machine learning tools built on top of Nx. Implements algorithms for:
  * Classification
  * Regression
  * Clustering
  * Dimensionality reduction
  * Metrics and preprocessing
* [EXGBoost](https://github.com/acalejos/exgboost) ⭐ 185 | 🐛 10 | 🌐 Elixir | 📅 2024-06-08 - Decision Trees implemented using the [XGBoost C API](https://xgboost.readthedocs.io/en/latest/c.html).
...
* [Axon](https://github.com/elixir-nx/axon) ⭐ 1,688 | 🐛 29 | 🌐 Elixir | 📅 2026-08-16 - Neural Networks for Elixir. Built with Nx.
* [Bumblebee](https://github.com/elixir-nx/bumblebee) ⭐ 1,661 | 🐛 33 | 🌐 Elixir | 📅 2026-07-22 - Pre-trained neural network models on top of Axon. Provides integration with [Hugging Face](https://huggingface.co/).
...
* [ReqLLM](https://github.com/agentjido/req_llm) ⭐ 562 | 🐛 3 | 🌐 Elixir | 📅 2026-08-18 - A Req-based package to call LLM APIs that standardizes the API calls and responses for LLM providers.
* [Arcana](https://github.com/georgeguimaraes/arcana) ⭐ 327 | 🐛 4 | 🌐 Elixir | 📅 2026-08-18 - Embeddable RAG library for Elixir/Phoenix with agentic pipelines and dashboard.
...
* [InstructorLite](https://github.com/martosaur/instructor_lite) ⭐ 142 | 🐛 1 | 🌐 Elixir | 📅 2026-08-17 - Lightweight structured outputs for LLMs using JSON schemas with multi-provider support including OpenAI, Anthropic, and Gemini.
...
* [TextChunker](https://github.com/revelrylabs/text_chunker_ex) ⭐ 110 | 🐛 11 | 🌐 Elixir | 📅 2026-08-18 - Semantic text chunking library optimized for vector embedding and RAG applications.
...
* [LLM Composer](https://github.com/doofinder/llm_composer) ⭐ 39 | 🐛 4 | 🌐 Elixir | 📅 2026-08-18 - Multi-provider LLM library with routing, fallback, streaming, and cost tracking for OpenAI, Anthropic, Gemini, and more.
...
* [Jido](https://github.com/agentjido/jido) ⭐ 1,808 | 🐛 4 | 🌐 Elixir | 📅 2026-08-14 - Framework for building autonomous, distributed agent systems with modular actions, stateful agents, and sensors. AI-framework agnostic.
* [LangChain](https://github.com/brainlid/langchain) ⭐ 1,193 | 🐛 31 | 🌐 Elixir | 📅 2026-08-18 - Framework for developing applications powered by language models, with support for OpenAI, Anthropic, Google, and Bumblebee models.
* [Sagents](https://github.com/sagents-ai/sagents) ⭐ 265 | 🐛 2 | 🌐 Elixir | 📅 2026-08-17 - Framework for interactive AI agents with OTP supervision, middleware composition, human-in-the-loop approvals, sub-agent delegation, and a Phoenix LiveView debugger.
* [Jido.AI](https://github.com/agentjido/jido_ai) ⭐ 202 | 🐛 2 | 🌐 Elixir | 📅 2026-08-18 - LLM integration layer for Jido. Provides actions and reasoning strategies (ReAct, Chain-of-Thought, Tree-of-Thoughts) for building intelligent agents with OpenAI, Anthropic, and other providers.
...
* [Tidewave Phoenix](https://github.com/tidewave-ai/tidewave_phoenix) ⭐ 846 | 🐛 5 | 🌐 Elixir | 📅 2026-08-18 - AI-powered development assistant for Phoenix web applications that connects editor AI assistants to web framework runtime via MCP.
* [Usage Rules](https://github.com/ash-project/usage_rules) ⭐ 218 | 🐛 1 | 🌐 Elixir | 📅 2026-08-01 - Tool for synchronizing LLM rules files with dependencies to prevent AI hallucinations and ensure consistent usage patterns.
...
* [Anubis MCP](https://github.com/zoedsoupe/anubis-mcp) ⭐ 165 | 🐛 16 | 🌐 Elixir | 📅 2026-08-17 - SDK for the Model Context Protocol (MCP) with support for multiple transport options (STDIO, HTTP/SSE, WebSocket).
...
* [llm\_db](https://github.com/agentjido/llm_db) ⭐ 55 | 🐛 1 | 🌐 Elixir | 📅 2026-08-18 - LLM model metadata database with O(1) lookups for provider capabilities, pricing, and context limits. Packaged as a dependency snapshot with no runtime network calls needed.
...
* [ex\_mcp](https://github.com/azmaveth/ex_mcp) ⭐ 21 | 🐛 1 | 🌐 Elixir | 📅 2026-08-13 - Complete Elixir implementation of the Model Context Protocol (v2025-11-25) with client and server support, multiple transports including native BEAM, and 2600+ tests.
