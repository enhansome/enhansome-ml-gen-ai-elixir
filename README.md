...
* [Soothsayer](https://github.com/georgeguimaraes/soothsayer) ⭐ 139 | 🐛 5 | 🌐 Elixir | 📅 2026-09-15 - Time series forecasting library inspired by Facebook's Prophet and NeuralProphet.
...
* [Stephen](https://github.com/georgeguimaraes/stephen) ⭐ 8 | 🐛 7 | 🌐 Elixir | 📅 2026-09-15 - ColBERT-style neural retrieval for Elixir.
* [Leidenfold](https://github.com/georgeguimaraes/leidenfold) ⭐ 5 | 🐛 6 | 🌐 Elixir | 📅 2026-09-15 - Elixir bindings for the Leiden community detection algorithm.
...
* [ReqLLM](https://github.com/agentjido/req_llm) ⭐ 575 | 🐛 2 | 🌐 Elixir | 📅 2026-09-15 - A Req-based package to call LLM APIs that standardizes the API calls and responses for LLM providers.
...
* [AshAi](https://github.com/ash-project/ash_ai) ⭐ 189 | 🐛 13 | 🌐 Elixir | 📅 2026-09-15 - Structured outputs, vectorization and tool calling for your Ash application with LangChain integration and MCP server capabilities.
...
* [Tribunal](https://github.com/georgeguimaraes/tribunal) ⭐ 113 | 🐛 0 | 🌐 Elixir | 📅 2026-09-15 - LLM evaluation framework that provides tools for evaluating and testing LLM outputs, detecting hallucinations, and measuring response quality
...
* [Jido](https://github.com/agentjido/jido) ⭐ 1,859 | 🐛 1 | 🌐 Elixir | 📅 2026-09-15 - Framework for building autonomous, distributed agent systems with modular actions, stateful agents, and sensors. AI-framework agnostic.
* [LangChain](https://github.com/brainlid/langchain) ⭐ 1,201 | 🐛 34 | 🌐 Elixir | 📅 2026-09-12 - Framework for developing applications powered by language models, with support for OpenAI, Anthropic, Google, and Bumblebee models.
...
* [claude-code-elixir](https://github.com/georgeguimaraes/claude-code-elixir) ⭐ 172 | 🐛 0 | 🌐 Python | 📅 2026-09-14 - Collection of Claude Code plugins for Elixir development. Includes LSP integration, formatting and compilation hooks, and thinking skills for Elixir, Phoenix, Ecto, and OTP patterns.
...
* [llm\_db](https://github.com/agentjido/llm_db) ⭐ 60 | 🐛 0 | 🌐 Elixir | 📅 2026-09-15 - LLM model metadata database with O(1) lookups for provider capabilities, pricing, and context limits. Packaged as a dependency snapshot with no runtime network calls needed.
...
* [Alike](https://github.com/georgeguimaraes/alike) ⭐ 45 | 🐛 4 | 🌐 Elixir | 📅 2026-09-15 - Semantic similarity testing library using a wave operator (`<~>`) for assertions. Tests whether sentences convey the same meaning rather than exact matches, ideal for validating LLM outputs.
